package __base_package__.iam.infrastructure.authorization.sfs.configuration;

import __base_package__.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import __base_package__.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import __base_package__.iam.infrastructure.tokens.jwt.BearerTokenService;
...
public class WebSecurityConfiguration {
     ...
     * It is not a bean on purpose: Spring Security would otherwise warn that a provider bean
     * overrides the user details service, and the filter chain registers it explicitly below.
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrfConfigurer -> csrfConfigurer.disable())
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        // Let the error dispatch through, or an unhandled 500 would surface as a 401
