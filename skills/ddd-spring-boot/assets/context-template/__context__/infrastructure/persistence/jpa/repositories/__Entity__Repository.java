...
public interface __Entity__Repository extends JpaRepository<__Entity__, Long> {
    /**
     * This method is used to check if a __entity__ exists by its name.
     * @param name The name of the __entity__.
     * @return A boolean indicating if the __entity__ exists.
     */
    boolean existsByName(String name);

    /**
     * This method is used to check if a __entity__ exists by its name and a different id.
     * @param name The name of the __entity__.
     * @param id The id of the __entity__.
     * @return A boolean indicating if a __entity__ exists with the same name but a different id.
     */
