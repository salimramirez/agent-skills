...
/**
 * Exception thrown when a __entity__ is not found.
 * @summary
 * This exception is thrown when a command names a __entity__ that does not exist.
 * @see RuntimeException
 */
public class __Entity__NotFoundException extends RuntimeException {
    /**
     * Constructor for the exception.
     * @param __entity__Id The id of the __entity__ that was not found.
     */
